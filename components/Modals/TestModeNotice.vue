...
const isTestCheckboxChecked = ref(false)

function handleCheckboxChange() {
  sessionStorage.setItem('dontShowTestNoticeMessage', isTestCheckboxChecked.value);
}
    ...
    >
      ...
      <div class="bg-white rounded-[10px] shadow overflow-y-auto">
        ...
        <div class="flex flex-col gap-y-[1.6rem] text-[1.6rem] font-[400] px-[40px] pb-[40px]">
          <h1 class="font-[600] text-[1.8rem] text-[#000] text-center">Test
            mode notice!</h1>
          <div class="flex flex-col gap-y-[2.4rem] text-[#616161]">
            <p>
              You are viewing your dashboard in test mode. All the data you are seeing in this mode is <strong>NOT
              REAL.</strong>
            </p>
            <div class="flex gap-x-[12px]">
              <input
                  v-model="isTestCheckboxChecked"
                  name="test"
                  type="checkbox"
